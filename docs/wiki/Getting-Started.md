...
![ConFigTree drop zone — browse or drop your Config.xlsx](../images/getting-started_browser_001_drop-zone-empty_3072x1620.png)
...
![XAML snippet tab with generated snippet and Copy button](../images/getting-started_browser_006_xaml-tab-snippet-copied_3072x1620.png)
...
![Install UiPath.CodedWorkflows from the official feed](../images/getting-started_studio_013_install-coded-activities-package-from-official-feed_1536x960.png)
...
![Cpmf.Config namespace added to the Imports panel](../images/getting-started_studio_022_namespace-is-added_1920x1080.png)
...
![XAML snippet pasted at the end of InitAllSettings](../images/getting-started_studio_023_paste-xaml-snippet-at-end-of-workflow-from-configtree-dot-cprima-dot-net_1920x1080.png)
...
![out_ConFigTree argument with Direction=Out and Type=CodedConfig](../images/getting-started_studio_031_check-argument-direction-is-out_1920x1080.png)
...
![Process.xaml now has access to the typed config](../images/getting-started_studio_042_Process-dot-xaml-now-has-access-to-coded-config_1920x1080.png)
